...
function ChangelogHintRequestControl(opts) {
    ...
    if (opts.value) {
        if (Buffer.isBuffer(opts.value)) {
            ...
            if (typeof (opts.value.url) !== 'string') {
                throw new TypeError('opts.value.url must be string');
            }
...
ChangelogHintRequestControl.prototype.parse = function parse(buffer) {
    ...
    if (ber.readSequence()) {
        ...
        this._value.url = ber.readString(asn1.Ber.Utf8String);
        return true;
    }
...
ChangelogHintRequestControl.prototype._toBer = function _toBer(ber) {
    ...
    if (this.value.url) {
        writer.writeString(this.value.url, asn1.Ber.Utf8String);
    } else {
