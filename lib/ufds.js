...
function createLDAPServer(options) {
    ...
    _server.bind(options.rootDN, function (req, res, next) {
        ...
        req.log.info({file: __filename, line: '88'}, 'res.end()');
        res.end();
        return next();
    });
    ...
    _server.exop('1.3.6.1.4.1.4203.1.11.3', function (req, res, next) {
        ...
        req.log.info({file: __filename, line: '97'}, 'res.end()');
        res.end();
        return next();
    });
    ...
    _server.search('', function (req, res, next) {
        ...
        res.send(entry);
        req.log.info({file: __filename, line: '135'}, 'res.end()');
        res.end();
        return next();
    });
    ...
    self.moray.putBucket(clog.bucket, {
        ...
        self.server.search('cn=changelogcount', function _log(req, res, next) {
            ...
            r.once('end', function () {
                ...
                req.log.info({file: __filename, line: '261'}, 'res.end()');
                res.end();
                return next();
            });
        });
